...
remoted.queue_max_bytes=104857600
remoted.batch_events_max_bytes=104857600
```
...
# Default: 104857600 (100 MiB). Set to 0 to disable.
remoted.queue_max_bytes=104857600
...
|--------|---------|-----|-------------|
| `remoted.queue_max_bytes` | `104857600` | `1024` | Byte cap for the input message queue |
| `remoted.batch_events_max_bytes` | `104857600` | `1024` | Byte cap for the outbound events queue toward the engine |
