...
int RemotedConfig(const char *cfgfile, remoted *cfg)
{
    ...
    queue_max_bytes = (size_t)getDefine_Int_default("remoted", "queue_max_bytes", 0, INT_MAX, 100 * 1024 * 1024);
    batch_events_max_bytes = (size_t)getDefine_Int_default("remoted", "batch_events_max_bytes", 0, INT_MAX, 100 * 1024 * 1024);
