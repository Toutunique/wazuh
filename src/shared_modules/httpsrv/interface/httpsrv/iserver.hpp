...
namespace httpsrv
{
    ...
    public:
         ...
         * function. The handler function is called when a request matching the specified method and route is received
         * by the server.
         *
        ...
        {
            return static_cast<ServerImpl*>(this)->isRunning();
        }
    };
} // namespace httpsrv
